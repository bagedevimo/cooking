...
module Argon2::Constants
  ENCODE_LEN = ::T.let(nil, ::T.untyped)
  OUT_LEN = ::T.let(nil, ::T.untyped)
  SALT_LEN = ::T.let(nil, ::T.untyped)
end
...
class JSON::Schema::Attribute
  ...
  def self.validate(current_schema, data, fragments, processor, validator, options=T.unsafe(nil)); end
...
class JSON::Schema::ValidationError
  ...
  def failed_attribute=(failed_attribute); end

  def fragments(); end

  def fragments=(fragments); end
...
module JSON::Util::URI
  ...
  def self.normalized_uri(uri, base_path=T.unsafe(nil)); end
...
class JSON::Util::UUID
  ...
  def self.create(clock=T.unsafe(nil), time=T.unsafe(nil), mac_addr=T.unsafe(nil)); end
  ...
  def self.create_v1(clock=T.unsafe(nil), time=T.unsafe(nil), mac_addr=T.unsafe(nil)); end
...
class JSON::Validator
  ...
  def self.deregister_format_validator(format, versions=T.unsafe(nil)); end

  def self.fully_validate(schema, data, opts=T.unsafe(nil)); end

  def self.fully_validate_json(schema, data, opts=T.unsafe(nil)); end

  def self.fully_validate_schema(schema, opts=T.unsafe(nil)); end

  def self.fully_validate_uri(schema, data, opts=T.unsafe(nil)); end
  ...
  def self.register_format_validator(format, validation_proc, versions=T.unsafe(nil)); end

  def self.register_validator(v); end

  def self.restore_default_formats(versions=T.unsafe(nil)); end
  ...
  def self.validate(schema, data, opts=T.unsafe(nil)); end

  def self.validate!(schema, data, opts=T.unsafe(nil)); end

  def self.validate2(schema, data, opts=T.unsafe(nil)); end

  def self.validate_json(schema, data, opts=T.unsafe(nil)); end

  def self.validate_json!(schema, data, opts=T.unsafe(nil)); end

  def self.validate_uri(schema, data, opts=T.unsafe(nil)); end

  def self.validate_uri!(schema, data, opts=T.unsafe(nil)); end

  def self.validator_for(schema_uri); end

  def self.validator_for_name(schema_name, raise_not_found=T.unsafe(nil)); end

  def self.validator_for_uri(schema_uri, raise_not_found=T.unsafe(nil)); end
...
class Rswag::Api::Configuration
  ...
  def swagger_filter=(swagger_filter); end

  def swagger_headers(); end

  def swagger_headers=(swagger_headers); end

  def swagger_root(); end

  def swagger_root=(swagger_root); end
end

class Rswag::Api::Configuration
end

class Rswag::Api::Engine
end
...
class Rswag::Specs::ConfigurationError
end
...
module Rswag::Specs::ExampleGroupHelpers
  ...
  def examples(example=T.unsafe(nil)); end
...
class Rswag::Specs::UnexpectedResponse
end
...
class Rswag::Ui::Configuration
  ...
  def basic_auth_enabled=(basic_auth_enabled); end

  def config_object(); end

  def config_object=(config_object); end

  def get_binding(); end

  def oauth_config_object(); end

  def oauth_config_object=(oauth_config_object); end
